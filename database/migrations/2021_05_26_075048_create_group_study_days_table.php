...
class CreateGroupStudyDaysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('group_study_days', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('group')->references('id')->on('group_lessons')->onUpdate('no action')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('group_study_days');
    }
}
