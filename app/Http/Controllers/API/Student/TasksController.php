...
class TasksController extends Controller
{
    ...
    {
        $tasks = Tasks::where('company', request()->user()->company)->where('assignee', request()->user()->id)->where('status', 1)->get();
    ...
    {
        Tasks::where('company', request()->user()->company)->where('id', $id)->delete();
